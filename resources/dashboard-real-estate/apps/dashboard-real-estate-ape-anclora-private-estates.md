...
# Dashboard Real Estate - APE - Anclora Private Estates
...
- App id: APE
- Scope: in_scope
- Layer: commercial-vertical
- Type: luxury-real-estate-platform
- Maturity: active
- Validation: documented_in_vault
- Focus: Luxury real estate en SW Mallorca
- Users: Clientes premium, compradores/vendedores de alto nivel, operador principal del ecosistema
