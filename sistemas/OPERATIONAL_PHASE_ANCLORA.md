...
"Codex, basándote en la nota de \[\[Arquitectura de Integración Anclora\]\] y el perfil de \[\[Elena Ejemplo\]\], prepárame un **guion de reunión de 15 minutos**. El objetivo es explicarle cómo Anclora Nexus va a proteger su pipeline de ventas usando la IA de Content Generator."
