...
export type ExecutiveDashboardData = {
  ...
  partners: Partner[]
  partnersLocales: Record<DashboardLanguage, Partner[]>
}
...
function localizeFocus(value: string, language: DashboardLanguage) {
      ...
      <header className="hero">
        <div className="hero__copy">
          ...
          <div className="hero__meta">
            <span>
              {t.focusLabel}:{' '}
              {localizeFocus(String(data.group.meta.territorio_foco ?? 'Suroeste de Mallorca'), language)}
            </span>
